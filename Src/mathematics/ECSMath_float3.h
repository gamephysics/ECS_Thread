...
#pragma pack(push,1)
    ...
    __declspec(selectany) const float3  float3::max  = float3( FLT_MAX,  FLT_MAX,  FLT_MAX);
    __declspec(selectany) const float3  float3::min  = float3( FLT_MIN,  FLT_MIN,  FLT_MIN);
    __declspec(selectany) const float3  float3::npos = float3( FLT_MIN,  FLT_MIN,  FLT_MIN);
#pragma pack(pop)
