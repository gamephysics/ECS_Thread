...
namespace ecs
{
	// https://github.com/Unity-Technologies/Unity.Mathematics/tree/master/src/Unity.Mathematics/Noise/cellular2x2x2.cs
	namespace noise
	{
		/// <summary>
		...
		static float2 cellular2x2x2(float3 P)
		{
