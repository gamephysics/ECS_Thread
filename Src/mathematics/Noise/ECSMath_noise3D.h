...
namespace ecs
{
	// https://github.com/Unity-Technologies/Unity.Mathematics/tree/master/src/Unity.Mathematics/Noise/noise3D.cs
	namespace noise
	{
		/// <summary>
		/// Simplex noise.
		...
		static float snoise(float3 v)
		{
			...
			m = m * m;
			return 42.0f * math::dot(m * m, float4(math::dot(p0, x0), math::dot(p1, x1), math::dot(p2, x2), math::dot(p3, x3)));
		}
	}
}
